...
class QitsOidcClientResourceOverridesOldExtrasTest {
  ...
  public static class BothSet implements QuarkusTestProfile {
    ...
    public Map<String, String> getConfigOverrides() {
      return Map.of(
          "QITS_RESOURCE_IDP_CLIENT_ID", "resource-qits-platform-maintenance",
  ...
  void theResourceEnvWinsOverTheOldExtrasEnv() {
    assertEquals("resource-qits-platform-maintenance", value("quarkus.oidc-client.qits.client-id"));
    assertEquals("resource-secret", value("quarkus.oidc-client.qits.credentials.secret"));
    assertEquals(
        "http://resource-idp:8080/idp", value("quarkus.oidc-client.qits.auth-server-url"));
  }
}
