 ...
 * — for a bump — a trigger into somebody else's pipeline and a release request opened at
 * qits-projects. A diagram drawn from the near side alone would say a scan is a POST. So there are
 * six feeds:
 *
 * <ul>
